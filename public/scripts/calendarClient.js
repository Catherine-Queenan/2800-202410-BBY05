	...
	var calendar = new FullCalendar.Calendar(calendarEl, {
		...
		eventClick: function(info) {
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control-plaintext" name="calModTrainer" id="calModTrainer">
			</div>

			<div class="mb-3">
				<label for="calModStart" class="form-label h3 modal-heading">Start Time</label>
				<input type="text" class="form-control-plaintext" name="calModStart" id="calModStart" value="${modStartTime}">
			</div>

			<div class="mb-3">
				<label for="calModEnd" class="form-label h3 modal-heading">End Time</label>
				<input type="text" class="form-control-plaintext" name="calModEnd" id="calModEnd" value="${modEndTime}">
			</div>
